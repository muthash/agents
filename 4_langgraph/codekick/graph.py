...
def _extract_text_from_response(resp) -> str:
    ...
    try:
        # resp.generations -> list[list[Generation]]
...
def planner_agent(state: dict) -> dict:
    ...
    # Build messages: include format instructions so the model returns JSON matching Plan
    messages = [
    ...
    raw = llm.invoke(messages, temperature=0)  # plain invoke, not with_structured_output
